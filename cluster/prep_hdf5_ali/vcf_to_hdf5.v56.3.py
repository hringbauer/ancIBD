...
if __name__ == "__main__":
    ...
    in_vcf_path = f"/n/data1/hms/genetics/reich/1000Genomes/ali/WholeGenomeImputation/imputed_r2/v{vrs}/1240k/chr{ch}.bcf" # f"/n/data1/hms/genetics/reich/1000Genomes/ali/WholeGenomeImputation/imputed_r2/v{vrs}/chr{ch}.bcf"
    ...
    vcf_to_1240K_hdf(in_vcf_path = in_vcf_path,
                     ...
                     map_path = map_path,
                     buffer_size=20000, chunk_width=8, chunk_length=10000,
                     ch=ch)
